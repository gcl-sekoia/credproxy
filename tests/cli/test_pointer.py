...
def test_set_and_read_default(xdg, workspaces_dir):
    from credproxy_cli.core.model.pointer import read_default, set_default
...
def test_clear_default_removes_pointer(xdg, workspaces_dir):
    from credproxy_cli.core.model.pointer import clear_default, read_default, set_default
    from credproxy_cli.core.model.workspace import Workspace
...
def test_clear_default_when_absent_is_noop(xdg):
    from credproxy_cli.core.model.pointer import clear_default
...
def test_resolve_default_no_pointer(xdg):
    from credproxy_cli.core.errors import WorkspaceError
    from credproxy_cli.core.model.pointer import resolve_default
...
def test_resolve_default_returns_workspace(xdg, workspaces_dir):
    from credproxy_cli.core.model.pointer import resolve_default, set_default
    from credproxy_cli.core.model.workspace import Workspace
